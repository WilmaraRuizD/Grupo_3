...
//     alert('Este es el evento click div1');
...
//     alert('Este es el evento click div2');
//     console.log(characters[demoArray[1]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray[1]].image}>
...
//     alert('Este es el evento click div3');
//     console.log(characters[demoArray[2]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray[2]].image}>
...
//     alert('Este es el evento click div4');
//     console.log(characters[demoArray[3]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray[3]].image}>
...
//     alert('Este es el evento click 5');
//     console.log(characters[demoArray[4]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray[4]].image}>
...
//     alert('Este es el evento click 6');
//     console.log(characters[demoArray[5]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray[5]].image}>
...
//     alert('Este es el evento click 7');
//     console.log(characters[demoArray1[0]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray1[0]].image}>
...
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray1[1]].image}>
...
//     alert('Este es el evento click 9');    console.log(characters[demoArray1[2]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray1[2]].image}>
...
//     alert('Este es el evento click 10');
//     console.log(characters[demoArray1[3]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray1[3]].image}>
...
//     alert('Este es el evento click 11');
//     console.log(characters[demoArray[0]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray1[4]].image}>
...
//     alert('Este es el evento click 12');
//     console.log(characters[demoArray1[5]].image)
//     div1.innerHTML =`<img class="personajes" src=${characters[demoArray1[5]].image}>
//     <p>${characters[demoArray1[5]].species}</p>
//     <p>${characters[demoArray1[5]].name}</p>
//     <p>${characters[demoArray1[5]].species}</p>
//    `
// })
